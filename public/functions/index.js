/**
 * CLOUD FUNCTIONS - GraveCare (GEN 1 - SIN EVENTARC)
 * Inicializa sepulturas y datos de usuario al completar suscripción
 * 
 * Usar esta versión para evitar problemas de Eventarc
 */
...
// ============================================================================
// TRIGGER 1: Al crear documento en /pagos (nuevo pago/suscripción) - GEN 1
// ============================================================================
exports.onPagoCreated = functions.firestore
  .document("pagos/{pagoId}")
  .onCreate(async (snapshot, context) => {
    const pagoData = snapshot.data();
...
// ============================================================================
// TRIGGER 2: Al actualizar estado de pago a "completado" - GEN 1
// ============================================================================
exports.onPagoCompletado = functions.firestore
  .document("pagos/{pagoId}")
  .onUpdate(async (change, context) => {
    const pagoAnterior = change.before.data();
    const pagoNuevo = change.after.data();
    const pagoId = context.params.pagoId;
